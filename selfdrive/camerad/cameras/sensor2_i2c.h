...
struct i2c_random_wr_payload init_array_ar0231[] = {
  ...
  // Wizard wont't generate vt_pix_clk_div = 6. Figure out why
  ...
  // Format
  {0x3040, 0xC000}, // READ_MODE_VERT_FLIP, 0x8000 = 1, READ_MODE_HORIZ_MIRROR, 0x4000 = 1, READ_MODE_COL_BIN, 0x2000 = 0, READ_MODE_ROW_BIN, 0x1000 = 0
  ...
  // {0x33E0, 0x0880}, // TEST_ASIL_ROWS = 2176
  ...
  {0x300C, 0x07E0}, // LINE_LENGTH_PCK = 2016

  // {0x3042, 0x09B8}, // EXTRA_DELAY
  {0x3042, 0x0000}, // EXTRA_DELAY
  // wizard says extra delay = 2488

  // Readout Settings

  // Keep old MIPI settings for now? What is different?
  ...
  // {0x3012, 0x00C6}, // COARSE_INTEGRATION_TIME = 198
  {0x3014, 0x08F2}, // FINE_INTEGRATION_TIME = 2290
  {0x321E, 0x08F2}, // FINE_INTEGRATION_TIME2 = 2290
  {0x3222, 0x08F2}, // FINE_INTEGRATION_TIME3 = 2290
  {0x3226, 0x08BB}, // FINE_INTEGRATION_TIME4 = 2235
