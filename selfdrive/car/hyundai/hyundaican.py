...
def create_acc_commands(packer, enabled, accel, accel_raw, idx, lead_visible, set_speed, stopping, gas_pressed):
  commands = []
  ...
  scc14_values = {
    ...
    "JerkUpperLimit": 12.7 if not stopping else 0,  # max jerk limits, aReq should control jerk
    "JerkLowerLimit": 12.7,
